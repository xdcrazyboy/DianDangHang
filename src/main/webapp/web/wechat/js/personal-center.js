    ...
    $(function() {
        ...
        function getTaskByPage(page, size, callback) {
            ...
            setTimeout(function() {
                /*联网获取数据*/
                var stutusTypes = [
                    { typeId: 1, typeImage: "../img/personCenter/完成.png", typeName: "已完成" },
                    { typeId: 2, typeImage: "../img/personCenter/进行中.png", typeName: "进行中" },
                ...
                var datas = [{
                        status_image: "../img/personCenter/完成.png",
                        status_name: "已完成",
                        task_type: "生活",
                    ...
                    {
                        status_image: "../img/personCenter/进行中.png",
                        status_name: "进行中",
                        task_type: "生活",
                        task_title: "取快递",
